...
void finder(size_t id, int step, std::vector<query*>* queries) {
    ...
    for (;;) {
        ...
        if (local_ctr == 100000) {
            ...
            case 146000000000UL:   xprintf("*** 146 billion. If this was distance traveled in meters, you would have now reached the sun, presuming distance to earth was the closest (perihelion, early January). ***\n"); break;
            case 152000000000UL:   xprintf("*** 152 billion. If this was distance traveled in meters, you would have now reached the sun, presuming distance to earth was the FARTHEST (aphelion, early July). ***\n"); break;
            case 197600250000UL:   xprintf("*** 197.6 billion. If we were traveling back in time at a pace of 1 address = 1 day, we would have now reached the beginning of the phanerozoic eon (541 mya (million years ago)) and returned into the proterozoic eon ***\n"); break;
            ...
            case 913125000000UL:   xprintf("*** 913.1 billion. [traveling back in time 1 addr=1 day] We have now passed through the proterozoic eon (starting 2,500 mya) and are entering into the archean eon. It will last for 1,500 mya ***\n"); break;
            ...
            case 31557600000000UL: xprintf("*** 31.5576 trillion. If 1 address equaled 1 second, you would have now passed 1 million years, assuming 1 year = 365.25 days ***                      \n"); break;
