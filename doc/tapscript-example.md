...
# We got a negated (01) pubkey 96f401...d4
```

Note: the pubkey we got was negated (01). Later when we do a Tapscript spend, we need to remember this, or the tapscript commitment may fail.

We now have our pubkey 96f401..d4. We can bech32-encode it to get an actual address. (Note: bech32-encode is temporarily hard-coded to use signet version 1 addresses. This will be made configurable.)
...
```Bash
$ bitcoin-cli -signet sendtoaddress sb1pjm6qzyv36gmgy6s8hxyjnqp25wmm0ceva2r2ef8c9n5flg60mn2q0w45px 0.0001
d4461a7d5d4120f7c3fd62c2f665b546129e4527a2bc2f1f7e7eedf4f77eba62
# (if you get fee estimation failed errors when sending, do `bitcoin-cli -signet settxfee 0.00001` and try again)
$ bitcoin-cli -signet getrawtransaction d4461a7d5d4120f7c3fd62c2f665b546129e4527a2bc2f1f7e7eedf4f77eba62 1
{
  "txid": "d4461a7d5d4120f7c3fd62c2f665b546129e4527a2bc2f1f7e7eedf4f77eba62",
  "hash": "66ffe429d7319627594328ce919aa1b9cce8e1746ff29b92a305b99df2873d8e",
  "version": 2,
  "size": 234,
  "vsize": 153,
  "weight": 609,
  ...
  "vin": [
    {
      "txid": "65c22aa2645575748621852ce6203c60cc7e53a8ab298cbd5fbb7b29879cb1ab",
      "vout": 1,
      "scriptSig": {
        "asm": "",
        "hex": ""
      ...
      "txinwitness": [
        "304402203562d886132f4b1c2872759874e02eddbebe6334c50c5cf74c7a07d336a51410022040d7961e242d5dcb435bdc05fa2f34b415f8073251e1868ca8ba44f67982cb1c01",
        "0242eb71f5a65b85e1ebd959008e46e26bd6439ba98a97e4276344bd564eb6921d"
      ],
      "sequence": 4294967294
    }
  ],
  "vout": [
    {
      ...
      "n": 0,
      "scriptPubKey": {
        "asm": "1 96f4011191d236826a07b98929802aa3b7b7e32cea86aca4f82ce89fa34fdcd4",
        "hex": "512096f4011191d236826a07b98929802aa3b7b7e32cea86aca4f82ce89fa34fdcd4",
        "reqSigs": 1,
    ...
    },
    {
      ...
      "n": 1,
      "scriptPubKey": {
        "asm": "0 5d056890231a3d66b9360ca32080656090551c94",
        "hex": "00145d056890231a3d66b9360ca32080656090551c94",
        "reqSigs": 1,
        "type": "witness_v0_keyhash",
        "addresses": [
          "sb1qt5zk3yprrg7kdwfkpj3jpqr9vzg928y5kfar4c"
        ]
      }
    }
  ],
  "hex": ""
}
```

We find our UTXO at index 0 above (yours may be at a different index, e.g. 1). Note type being witness_unknown, and note asm starting with a 1, as opposed to a 0. this is the segwit version.

We will need the hex value from this one later. We refer to it as "txin" and set a shell var to it for now:

```Bash
$ txin=
```
...
$ bitcoin-cli -signet createrawtransaction '[{"txid":"d4461a7d5d4120f7c3fd62c2f665b546129e4527a2bc2f1f7e7eedf4f77eba62", "vout":0}]' '[{"sb1qpkxrw8snhrzx8gkkn4d5w34tr0zeahlk83vnl0":0.00009}]'
...
```Bash
$ bitcoin-cli -signet testmempoolaccept '[""]'
[
  {
...
- path len = 1
- p        = b58eb8b662b67e63452b8bd6a270ffcdc5497212f9fabf22c2f830a4588df05b
- q        = d4dc4fa39fe82cf8a4ac86ea2ce3b7b7a32a802989b9076a8236d2911101f496
...
```Bash
$ bitcoin-cli -signet sendrawtransaction 
$ bitcoin-cli -signet getrawtransaction 61d6e879d1c791806283d13d561870f3bcecab877b1b719e207380f611bd4760 1
{
  "txid": "61d6e879d1c791806283d13d561870f3bcecab877b1b719e207380f611bd4760",
