...
btcdeb: kerl/kerl.o btcdeb.cpp bitcoin
	g++ -std=c++11 $(CXXFLAGS) -I. -Wall -Wno-unused -Wno-sign-compare -Wno-reorder -Wno-comment btcdeb.cpp kerl/kerl.o *.o crypto/*.o -o btcdeb -lreadline

btcc: btcc.cpp bitcoin
	g++ -std=c++11 $(CXXFLAGS) -I. -Wall -Wno-unused -Wno-sign-compare -Wno-reorder -Wno-comment btcc.cpp *.o crypto/*.o -o btcc
...
%.o: %.cpp %.h
	g++ -std=c++11 $(CXXFLAGS) -I. -Wall -Wno-unused -Wno-sign-compare -Wno-reorder -Wno-comment -c -o $@ $<
